...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    public void testProcessMp4(){
        ...
        //ffmpeg的路径
        String ffmpeg_path = "E:\\ffmpeg-20191120-7ead0da-win64-static\\bin\\ffmpeg.exe";
        //video_path视频地址
        String video_path = "D:\\BaiduNetdiskDownload\\15-Spring Boot\\01.spring boot 介绍\\01-SpringBoot课程内容介绍.flv";
        //mp4_name mp4文件名称
        String mp4_name  ="007.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path="E:\\ffmpeg-20191120-7ead0da-win64-static\\test\\";
